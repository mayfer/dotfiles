" Vim color file
" Converted from Textmate theme Blackboard using Coloration v0.3.2 (http://github.com/sickill/coloration)
...
hi Folded ctermfg=249 ctermbg=NONE cterm=NONE guifg=#aeaeae guibg=#0c1021 gui=NONE
...
hi NonText ctermfg=59 ctermbg=NONE cterm=NONE guifg=#494c59 guibg=#181c2c gui=NONE
